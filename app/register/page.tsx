          ...
          <div className="max-w-4xl mx-auto">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <RadioGroup
                        ...
                        onValueChange={(value) => updateFormData("batchType", value)}
                        ...
                        {batchTypes.map((batch) => (
                          ...
                          >
                            <div className="flex items-center space-x-3">
                              ...
                              <Label htmlFor={batch.id} className="font-medium cursor-pointer">
                                {batch.name}
                              </Label>
                            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => updateFormData("preferredBatch", value)}
                        >
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => updateFormData("passingYear", value)}
                        >
                          <SelectTrigger className="h-12">
                      ...
                      <div className="bg-secondary/30 rounded-lg p-4">
                        ...
                        <div className="grid md:grid-cols-2 gap-3 text-sm">
                          ...
                          <div>
                            ...
                            <span className="font-medium">
                              {batchTypes.find(b => b.id === formData.batchType)?.name || "-"}
                            </span>
                          </div>
                          <div>
                            <span className="text-muted-foreground">Preferred Batch:</span>{" "}
                            <span className="font-medium">{formData.preferredBatch || "-"}</span>
                          </div>
                          <div>
                            <span className="text-muted-foreground">Hostel:</span>{" "}
                            <span className="font-medium">{formData.hostelRequired ? "Yes" : "No"}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-secondary/30 rounded-lg p-4">
                        ...
                        <div className="grid md:grid-cols-2 gap-3 text-sm">
                          <div>
                            ...
                            <span className="font-medium">{formData.highestQualification || "-"}</span>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <span className="font-medium">{formData.passingYear || "-"}</span>
                          </div>
                          <div>
            ...
            <div className="mt-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="mailto:admissions@warriorsdefence.com"
                  className="flex items-center justify-center gap-2 text-primary hover:underline"
                >
                  <Mail className="h-4 w-4" />
                  admissions@warriorsdefence.com
                </a>
              </div>
            </div>
          </div>
