...
Updated from **Google Search Console** (3 months ending 2026-09-11).  
See also: [`GSC-INSIGHTS-2026-09.md`](./GSC-INSIGHTS-2026-09.md) · [`gsc-queries-3m.csv`](./gsc-queries-3m.csv)

## How to use

1. One **primary keyword** per page (no duplicates).
2. Mirror primary in: title, H1, first 100 words, meta description, `focusKeyword`.
3. Update `keyword-map.csv` in the same change.
4. Prefer **GSC-proven local commercial** terms over vanity national head terms.

## GSC homepage cluster (2026-09-11)

| Keyword | Role | GSC signal | Placement |
|---|---|---|---|
