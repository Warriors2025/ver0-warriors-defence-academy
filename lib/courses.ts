...
const STATIC_COURSES: CourseListItem[] = [
  { id: "nda", slug: "nda", title: "NDA Course", tagline: "Best NDA coaching in Lucknow — written + SSB", description: "NDA coaching in Lucknow covering UPSC NDA written exam and full SSB interview prep with India's largest GTO ground.", duration: "6–12 Months", students: "2,000+", rating: 4.8, badge: "Best Seller", badgeColor: "bg-accent text-accent-foreground", category: "officer", image: "/images/courses/nda.webp", features: ["Written Exam Prep", "SSB Interview Training", "Weekly Mock Tests", "Physical Fitness"], href: "/courses/nda" },
  { id: "nda-foundation", slug: "nda-foundation", title: "NDA Foundation Course", tagline: "NDA foundation coaching after 10th in Lucknow", description: "NDA foundation coaching after 10th in Lucknow — integrated Class 11–12 schooling with NDA written, PT and early SSB grooming.", duration: "2–3 Years", students: "500+", rating: 4.9, badge: "Popular", badgeColor: "bg-primary text-primary-foreground", category: "officer", image: "/images/courses/nda-foundation.webp", features: ["Integrated Schooling", "Hostel Facility", "Daily Physical Training", "Early SSB Grooming"], href: "/courses/nda-foundation" },
  { id: "cds", slug: "cds", title: "CDS Course", tagline: "CDS coaching in Lucknow for graduate officers", description: "CDS coaching in Lucknow with subject masters, current affairs and SSB preparation for IMA, INA, AFA and OTA.", duration: "6 Months", students: "1,500+", rating: 4.8, badge: null, badgeColor: "", category: "officer", image: "/images/courses/cds.webp", features: ["Complete Syllabus", "Daily Current Affairs", "Previous Year Analysis", "SSB Prep Included"], href: "/courses/cds" },
  { id: "ssb", slug: "ssb", title: "SSB Interview Training", tagline: "Best SSB coaching in Lucknow on real GTO ground", description: "SSB coaching in Lucknow with OIR practice, psychology, GTO tasks and interview drills on India's largest GTO ground.", duration: "21 Days", students: "3,000+", rating: 4.9, badge: "Top Rated", badgeColor: "bg-accent text-accent-foreground", category: "officer", image: "/images/courses/ssb.webp", features: ["Live GTO Tasks", "OIR & Psychology Mocks", "Mock SSB Interviews", "OLQ Development"], href: "/courses/ssb" },
